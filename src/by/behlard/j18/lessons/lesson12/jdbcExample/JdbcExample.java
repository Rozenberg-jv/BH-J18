package by.behlard.j18.lessons.lesson12.jdbcExample;

import by.behlard.j18.lessons.lesson12.Employee;
import by.behlard.j18.lessons.lesson12.Specialty;
...
//        String name = "Oleg";
        /*statement.execute(
                String.format("insert into employees value (null, '%s', '2019-01-01', %d, %d)"
                        , name, 1, 1500));*/
